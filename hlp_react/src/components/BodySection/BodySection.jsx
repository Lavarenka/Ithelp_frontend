                    ...
                    <div class="body_item">
                      <div class=" my-1 card_ ">
                        ...
                        <div class="card_title ">
                          <h2>
                            Подключаем Offcanvas для меню с помощью Bootstrap.
                          </h2>
                        </div>
                        {/* <div class="my-2"><img src="assets/img/it.png" alt=""></div> */}
                        <div class="card_description">
                          <p>
                            Offcanvas — это компонент боковой панели, который
                            можно переключать с помощью JavaScript, чтобы он
                            появлялся с левого, правого, верхнего или нижнего
                            края области просмотра. Кнопки или привязки
                            используются в качестве триггеров, прикрепленных к
                            конкретным элементам, которые вы переключаете, а
                            dataатрибуты используются для вызова нашего
                            JavaScript.
                          </p>
                        </div>
                    ...
                    <div class="body_item">
                      <div class=" my-1 card_ ">
                        ...
                        <div class="d-flex mb-2">
                          <div class="me-2">
                            <i
                              class="fa-brands fa-python fa-xl"
